...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Promoter2}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_1");
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Switch2}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_2");
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_ProteinCodingRegion2}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_3");
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_exon}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_4");
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Intron}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_5");
...
Symbol.bindElementAction(compId,symbolName,"${_box4}","click",function(sym,e){sym.playReverse();});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_startcodon2}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_6");
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_stopcodon2}","click",function(sym,e){sym.playReverse();});
//Edge binding end
})("box_7");
